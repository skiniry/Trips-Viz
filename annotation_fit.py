...
#     sarscov2_sqlite = '/home/jack/projects/trips/Trips-Viz/trips_annotations_sample/sarscov2/sarscov2.sarscov2_homo_sapiens.sqlite'
#     sarscov2_read_file = '/home/jack/projects/trips/Trips-Viz/trips_shelves/riboseq/sarscov2/Finkel20/SRR12216748.sqlite'

#     start = time.time()
#     connection = get_annotation_connection(sarscov2_sqlite)
#     dic = SqliteDict(sarscov2_read_file)
#     offsets = get_offsets_for_read_file(sarscov2_read_file)
#     print "Setup: ", time.time() - start 
#     gene = get_gene_from_transcript("NC_045512", connection)
#     gene_info = get_gene_info(gene, connection)
#     transcript_architecture_dict = transcript_architecture(gene_info)
#     print "Structures: ", time.time() - start 
...
#         coding_regions.sort()
#         time2 = time.time()
#         print transcript_id, time2 - time1

#         transcript_counts = get_reads_per_transcript_location(transcript_id, sarscov2_read_file)

#         counts_per_region = get_counts_per_region(transcript_architecture_dict[transcript_id], transcript_counts, offsets, coding_regions)
#         locus_counts[transcript[0]] = counts_per_region
#         print transcript_id, time.time() - start 

    
#     print 
#     for i in locus_counts:
#         print i, round(float(locus_counts[i]['coding']), 2)/round(float(locus_counts[i]['five_prime'] + locus_counts[i]['three_prime']),2)
